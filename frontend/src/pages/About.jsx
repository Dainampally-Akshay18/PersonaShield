    ...
    <div className="max-w-5xl mx-auto space-y-24 py-12">
      ...
      <section className="text-center space-y-8">
        ...
        <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-slate-900">
          THE MISSION OF <br />
          <span className="text-blue-600 italic">PERSONASHIELD</span>
        </h1>
        <p className="max-w-3xl mx-auto text-lg text-slate-700 leading-relaxed font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="p-10 space-y-6 bg-white border-slate-200">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-300">
              <Cpu className="w-6 h-6 text-blue-600" />
            </div>
            <h3 className="text-xl font-black uppercase tracking-tight text-slate-900">Recursive Logic Engine</h3>
          </div>
        ...
        <Card className="p-10 space-y-6 bg-white border-slate-200">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-xl font-black uppercase tracking-tight text-slate-900">Adversarial POV</h3>
          </div>
          <p className="text-slate-700 text-sm leading-relaxed">
      ...
      <section className="space-y-16">
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-black uppercase tracking-tighter text-slate-900">OUR METHODOLOGY</h2>
          <div className="h-1 w-24 bg-blue-600/50 mx-auto rounded-full" />
        </div>
          ...
          {methodology.map((m, i) => (
            <div key={i} className="relative group">
              <div className="mb-6 flex items-end justify-between">
                <span className="text-5xl font-black text-slate-300 group-hover:text-blue-600/20 transition-colors duration-500">
                  {m.step}
                </span>
                <div className="p-4 bg-white border border-slate-300 rounded-2xl group-hover:scale-110 transition-transform duration-500 shadow-md shadow-slate-200">
                  <m.icon className="w-6 h-6 text-blue-600" />
                </div>
              </div>
              <h4 className="text-lg font-black uppercase tracking-widest mb-3 text-slate-900">{m.title}</h4>
              <p className="text-xs text-slate-700 leading-relaxed font-bold uppercase tracking-wider">{m.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Lab Terminal Footer */}
      <Card className="p-8 bg-slate-50 border-blue-600/20 border-2">
        <div className="flex items-center gap-3 mb-6">
          <Terminal className="w-4 h-4 text-blue-600" />
          <span className="text-xs font-mono text-blue-700/70 uppercase tracking-widest">adversarial_lab.sh</span>
        </div>
        <div className="font-mono text-[10px] md:text-sm text-blue-700/50 leading-relaxed space-y-1">
          <p className="text-blue-700/90 tracking-tighter">{`>> initializing PersonaShield Alpha v4.2...`}</p>
          ...
          <div className="w-2 h-4 bg-blue-600 animate-pulse mt-4" />
        </div>
      </Card>
    </div>
  );
